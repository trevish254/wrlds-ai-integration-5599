...
import { Palette, Code, Truck, Zap, ArrowRight, Box, CheckCircle, Rocket, Factory, Microchip, Handshake, RefreshCcw, MessageSquare } from "lucide-react";
...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: "Web & app development, AI integration, SaaS platforms, and digital marketing that help businesses embrace technology and automation.",
      image: "/lovable-uploads/48e540e5-6a25-44e4-b3f7-80f3bfc2777a.png"
    },
    {
      icon: <Palette className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Creative Media",
      description: "Branding, advertising, photography, videography (including CGI & VFX), events, and interior design that tell powerful stories.",
      image: "/lovable-uploads/48ecf6e2-5a98-4a9d-af6f-ae2265cd4098.png"
    },
    {
      icon: <Truck className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Ventures",
      description: "Affordable furniture & carpentry, decor, lifestyle products, cyber kiosks, and AgriTech platforms solving everyday challenges.",
      image: "/lovable-uploads/cf8966e3-de0d-445f-9fbd-ee6c48daa7ff.png"
    },
    {
      icon: <Zap className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Innovation Hub",
      description: "A future-driven African brand that combines tech + creativity + entrepreneurship to transform ideas into impactful solutions.",
  ...
  const serviceCaseStudies = [{
    ...
    description: "Complete brand development with logo design, brand guidelines, and marketing materials for growing African businesses."
  }, {
    image: "/lovable-uploads/5463c9c5-0946-4280-a14b-17636ff69a98.png",
    title: "Web & App Development",
    description: "Custom web applications, mobile apps, and SaaS platforms that drive business growth and user engagement."
  }, {
    image: "/lovable-uploads/c5f8ee24-9815-4ebe-b65d-6f3d449feb8b.png",
    title: "Creative Content Production",
    description: "High-quality photography, videography, CGI & VFX production for campaigns, events, and digital marketing."
  }];
  
  const stepFlowItems = [{
    icon: <Microchip className="h-10 w-10 text-gray-700" />,
    title: "Aventis Innovation Process",
    description: "Our proven methodology for transforming ideas into market-ready solutions"
  }, {
    icon: <Factory className="h-10 w-10 text-gray-700" />,
    title: "Multi-Division Expertise",
    description: "Digital Solutions, Creative Media, and Ventures working in perfect harmony"
  }, {
    icon: <Handshake className="h-10 w-10 text-gray-700" />,
    title: "Strategic Partnerships",
    description: "Collaborating with African businesses and international partners for maximum impact"
  }];
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}> 
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Aventis transforms ideas into impactful solutions through our three core divisions: Digital Solutions, Creative Media, and Ventures. 
              We help people, communities, and businesses grow across Africa.
            </p>
          </div>
          ...
          <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold">Real Impact, Real Results</h3>
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                Explore how Aventis delivers exceptional results across our three divisions, 
                from brand development to digital transformation and innovative ventures.
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              <Carousel className="w-full max-w-7xl mx-auto">
                <CarouselContent className="flex">
                  {serviceCaseStudies.map((study, index) => <CarouselItem key={index} className="md:basis-1/3 flex-shrink-0">
              ...
              <div className="text-center mt-6 text-sm text-gray-600">
                <p className="font-medium">These examples showcase just a few ways Aventis transforms ideas into impactful solutions</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="technology" className="bg-gray-50 py-10 md:py-16">
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">How Aventis Works</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Aventis combines technology, creativity, and entrepreneurship through our integrated approach, 
              allowing us to develop completely unique solutions at high speed and maximum impact.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 mb-10 transition-all duration-300 hover:shadow-xl">
              ...
              {stepFlowItems.map((item, index) => <HoverCard key={index}>
                  ...
                  <HoverCardContent className="w-80 shadow-lg">
                    <div className="space-y-2">
                      ...
                      {index === 0 && <p className="text-xs text-gray-500">Our innovation process ensures every project delivers maximum value and sustainable growth.</p>}
                      {index === 1 && <p className="text-xs text-gray-500">Three specialized divisions working together to deliver comprehensive solutions.</p>}
                      {index === 2 && <p className="text-xs text-gray-500">Strategic partnerships across Africa and beyond for scalable impact.</p>}
                    </div>
                  </HoverCardContent>
                </HoverCard>)}
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <div className="mb-6">
                <h3 className="text-xl font-bold mb-2">Sprint {currentSprint}: {sprintPhases[currentSprint - 1]?.name}</h3>
                <p className="text-gray-600 text-sm">
                  {currentSprint === 1 && "Discovering opportunities and understanding client needs through comprehensive research and analysis."}
                  {currentSprint === 2 && "Developing strategic approaches and creating actionable plans for maximum impact and growth."}
                  {currentSprint === 3 && "Implementing solutions with precision and monitoring progress to ensure successful outcomes."}
                </p>
              </div>
                  ...
                  {sprintPhases.map((phase, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <div className={cn(
                        ...
                        currentSprint === index + 1 ? "bg-gray-600 text-white" : "bg-gray-200 text-gray-500"
                      )}>
                        {phase.icon}
                      </div>
                      <span className={cn(
                        "text-sm font-medium",
                        currentSprint === index + 1 ? "text-gray-800" : "text-gray-500"
                      )}>
                        {phase.name}
                      </span>
                    </div>
