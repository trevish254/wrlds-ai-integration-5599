      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6">
              Aventis is an African innovation hub building digital solutions, creative media, and ventures that empower growth and innovation across the continent.
            </p>
            <p className="text-gray-300 mb-6">
              Hornsgatan 110<br />
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.linkedin.com/company/aventis/" 
                target="_blank" 
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Aventis. All rights reserved.
          </p>
